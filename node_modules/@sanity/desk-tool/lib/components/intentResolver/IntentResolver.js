...
var IntentResolver = /*#__PURE__*/_react.default.memo(function IntentResolver(_ref) {
  ...
  var _useDocumentType = (0, _resolveDocumentType.useDocumentType)(documentId, specifiedSchemaType),
      documentType = _useDocumentType.documentType,
      isLoaded = _useDocumentType.isLoaded;

  var paneSegments = (0, _react.useMemo)(() => documentType ? [[{
    id: documentType,
    params: otherParams
  }], [{
    id: documentId,
    params: otherParams,
    payload
  }]] : undefined, [documentId, documentType, otherParams, payload]);
  ...
  var panes = (0, _react.useMemo)(() => {
    ...
    var newDocumentId = documentId === FALLBACK_ID ? (0, _uuid.uuid)() : (0, _resolveDocumentType.removeDraftPrefix)(documentId);
