...
function FormView(props) {
  ...
  var _useDocumentPane = (0, _useDocumentPane2.useDocumentPane)(),
      ...
      permission = _useDocumentPane.permission,
  ...
  var value = (0, _react.useMemo)(() => ready ? displayed : null, [displayed, ready]);
  ...
  var readOnly = (0, _react.useMemo)(() => {
    return !ready || rev !== null || !permission.granted || !(0, _documentActionUtils.isActionEnabled)(documentSchema, 'update') || isNonExistent && !(0, _documentActionUtils.isActionEnabled)(documentSchema, 'create');
  ...
  }, [compareValue, documentSchema, filterField, focusPath, handleBlur, handleChange, handleFocus, hasTypeMismatch, margins, markers, patchChannelRef, presence, readOnly, value]);
