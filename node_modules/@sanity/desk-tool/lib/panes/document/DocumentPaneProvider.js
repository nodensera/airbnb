...
var DocumentPaneProvider = function DocumentPaneProvider(props) {
  ...
  var initialValueRaw = (0, _initialValue.useInitialValue)(options.id, pane.options);
  ...
  var permission = (0, _hooks.unstable_useCheckDocumentPermission)(documentId, documentType, requiredPermission);
  ...
  var ready = connectionState === 'connected' && !patch.disabled;
  var displayed = (0, _react.useMemo)(() => {
  ...
  var documentPane = (0, _react.useMemo)(() => ({
    ...
    value,
    views
  }), [actions, activeViewId, badges, changesOpen, compareValue, connectionState, displayed, documentId, documentIdRaw, documentType, documentSchema, editState, focusPath, handleChange, handleFocus, handleHistoryClose, handleHistoryOpen, handleInspectClose, handleKeyUp, handleMenuAction, handlePaneClose, handlePaneSplit, historyController, index, initialValue, inspectOpen, markers, menuItems, menuItemGroups, paneKey, permission, previewUrl, ready, requiredPermission, setTimelineMode, setTimelineRange, timeline, timelineMode, title, value, views]);
  (0, _react.useEffect)(() => {
