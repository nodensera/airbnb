...
var _resolveDocumentType = require("../../lib/resolveDocumentType");
...
var DocumentPane = /*#__PURE__*/(0, _react.memo)(function DocumentPane(props) {
  ...
  var _useDocumentType = (0, _resolveDocumentType.useDocumentType)(options.id, options.type),
  ...
  return /*#__PURE__*/_react.default.createElement(_DocumentPaneProvider.DocumentPaneProvider, providerProps, /*#__PURE__*/_react.default.createElement(InnerDocumentPane, null));
});
...
function InnerDocumentPane() {
  ...
  var inspectDialog = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_components.LegacyLayerProvider, {
    ...
    value: displayed || initialValue.value
  ...
  }, [changesOpen, changesPanel, documentPanel, documentSchema, documentType, footer, handleFocus, handleHistoryOpen, initialValue.error, inspectDialog, layoutCollapsed, value, zOffsets.portal]);
